...
sudo docker run -d -p 80:80 --name=lamp -v /<path_to_container_folder>/www:/var/www/html -v /<path_to_container_folder>/data/mysql:/var/lib/mysql -v /<path_to_container_folder>/data/apache2:/etc/apache2/sites-available <your_username>/lamp
